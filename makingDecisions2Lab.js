...
//Code Here
for(let v = 0 ; v < listOfNumbers.length ; v++){
  if (listOfNumbers[v] % 3 == 0){
    console.log(`${listOfNumbers[v]} is divisible by 3`)
  }
}
...
//Code Here
for (var i = 1; i < 101; i++) {
  if (i % 15 == 0) console.log("DevMountain");
